...
/**
 * Clase que comprueba el comportamiento de la ventana de signUp
 *
 * @author Gonzalo y Eneko
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class SignUpControllerTest extends ApplicationTest {

    /**
     * The class that will check signup window behavior
     *
     * @param stage
     * @throws Exception
     */
    ...
    /**
     * Check that button accept is enable with everything filled and disable
    ...
    public void test2_ButtonAcceptControl() {
       ...
       // verifyThat(Alert,"",NodeMatcher.);
        

    }

    /**
     * Check the different ways of introducing a passwd
     */
    @Test
    ...
    /**
     * Check that when button accept is clicked and the data is correct you move
     * to login window
     */
    @Test
